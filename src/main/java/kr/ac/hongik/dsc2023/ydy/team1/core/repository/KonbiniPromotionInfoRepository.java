...
public interface KonbiniPromotionInfoRepository extends JpaRepository<PromotionInfo, Long> {
    List<PromotionInfo> findAllByItem_NameContainsAndStartDateGreaterThanEqualAndEndDateGreaterThanEqual(String name,
                                                                                                         LocalDate startDate,
                                                                                                         LocalDate endDate);
    ...
    List<PromotionInfo> findByItem_CategoryAndStartDateAndEndDate(ItemCategory itemCategory, LocalDate startDate,
                                                                  LocalDate endDate);
}
