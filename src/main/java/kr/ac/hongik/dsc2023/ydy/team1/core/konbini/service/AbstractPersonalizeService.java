...
public abstract class AbstractPersonalizeService implements PersonalizeService {
    ...
    public void recommend(PersonalizeEvent personalizeEvent){
        ...
        Map<String, Object> recommendData = updateRecentAccessInfo(memberProfile.getRecommendData(), promotionInfo.getItem());
     ...
     */
    protected abstract Map<String, Object> updatePreferInfo(Item item, Map<String, Object> accessLogUpdatedRecommendData, PreferStrong preferStrong);
